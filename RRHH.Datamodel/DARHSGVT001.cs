...
namespace RRHH.Datamodel
{
    ...
    {
        public void AdicionarVacacionesTrabajador (List<ThrPeopleVacation> listadoVacacionesXPersona, int periodo)
        {
        ...
        public List<ThrPeopleVacation> VacacionesXPersona(int personkey, int periodo)
        {
            using (var newcontexto = new Sage500AppEntities(Conection.connectionString))
            {
