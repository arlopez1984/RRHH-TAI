...
namespace RRHH.Datamodel
{
    ...
    {
        public void AdicionarTiempoTrabajado(ThrWorkedTime worktime, List<clsHorasCondiciones> listadoCondicionesHoras)
        {
            int worktimekey;
        ...
        public ThrWorkedTime TiempoTrabajadoXPersona(int personkey, int periodo)
        {
            using (var newcontexto = new Sage500AppEntities(Conection.connectionString))
            {
        ...
        public decimal TiemposTrabajadosXPersona(int personkey, int periodo)
        {
            using (var newcontexto = new Sage500AppEntities(Conection.connectionString))
            {
        ...
        public ThrPosition CargoXPersona(int cargokey)
        {
            using (var newcontexto = new Sage500AppEntities(Conection.connectionString))
            {
        ...
        public List<ThrAnormalCondPosition> CondicionesXCargo(int cargokey)
        {
            using (var newcontexto = new Sage500AppEntities(Conection.connectionString))
            {
        ...
        public List<ThrWorkedTimeAnormalCondition> DevolverCondicionesxTrabajador(int workerTiemkey)
        {
            using (var newcontexto = new Sage500AppEntities(Conection.connectionString))
            {
