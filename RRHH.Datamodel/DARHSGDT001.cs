...
namespace RRHH.Datamodel
{
    ...
    {
        public void AdicionarDeducionesTrabajador(List<ThrPeopleDeduction1> listadoDeduccionesXPersona, int periodo)
        {
            //int deductionkey;           
        ...
        public List<ThrPeopleDeduction1> DeduccionesXPersona(int personkey, int periodo)
        {
            using (var newcontexto = new Sage500AppEntities(Conection.connectionString))
            {
