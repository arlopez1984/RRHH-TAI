...
// Code is generated on: 03/01/2021 22:52:01
//
...
namespace Sage500AppModel
{
    ...
    public partial class Sage500AppEntities : ObjectContext
    {
        ...
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<ThrDatosRptsTemporal> ThrDatosRptsTemporals
        {
            get
            {
                if ((_ThrDatosRptsTemporals == null))
                {
                    _ThrDatosRptsTemporals = base.CreateObjectSet<ThrDatosRptsTemporal>("ThrDatosRptsTemporals");
                }
                return _ThrDatosRptsTemporals;
            }
        }
        private ObjectSet<ThrDatosRptsTemporal> _ThrDatosRptsTemporals;

        /// <summary>
        /// No Metadata Documentation available.
        /// </summary>
        public ObjectSet<ThrUnitTurno> ThrUnitTurnos
        {
            get
            {
                if ((_ThrUnitTurnos == null))
                {
                    _ThrUnitTurnos = base.CreateObjectSet<ThrUnitTurno>("ThrUnitTurnos");
                }
                return _ThrUnitTurnos;
            }
        }
        private ObjectSet<ThrUnitTurno> _ThrUnitTurnos;
        ...
        /// <summary>
        /// Deprecated Method for adding a new object to the ThrDatosRptsTemporals EntitySet.
        /// </summary>
        public void AddToThrDatosRptsTemporals(ThrDatosRptsTemporal thrDatosRptsTemporal)
        {
            base.AddObject("ThrDatosRptsTemporals", thrDatosRptsTemporal);
        }

        /// <summary>
        /// Deprecated Method for adding a new object to the ThrUnitTurnos EntitySet.
        /// </summary>
        public void AddToThrUnitTurnos(ThrUnitTurno thrUnitTurno)
        {
            base.AddObject("ThrUnitTurnos", thrUnitTurno);
        }
...
namespace Sage500AppModel
{
    ...
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Condiciones Anormales")]
    ...
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Empresa")]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    public partial class ThrCompany : EntityObject    {
        ...
        [Net4Sage.Controls.Lookup.LookupShowColumn]
        [Net4Sage.Controls.Lookup.LookupTextReturn]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"ID Empresa")]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"ID Empresa")]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Nivel")]
    public partial class ThrCulturalLevel : EntityObject    {
        ...
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"Id Nivel")]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"Id Nivel")]
        [Net4Sage.Controls.Lookup.LookupTextReturn]
        [Net4Sage.Controls.Lookup.LookupShowColumn]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Grupo de Escala")]
    public partial class ThrEscalaGroup : EntityObject    {
        ...
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"ID Grupo de Escala")]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"ID Grupo de Escala")]
        [Net4Sage.Controls.Lookup.LookupShowColumn]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búqsueda de Categorías Ocupacionales")]
    public partial class ThrOcupationalCategory : EntityObject    {
        ...
        [Net4Sage.Controls.Lookup.LookupShowColumn]
        [Net4Sage.Controls.Lookup.LookupTextReturn]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"ID Categoría")]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"ID Categoría")]
        public virtual string CategoryID
        {
            get
            {
    ...
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Clasificaciones Ocupacionales")]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    public partial class ThrOcupationClasification : EntityObject    {
        ...
        [Net4Sage.Controls.Lookup.LookupTextReturn]
        [Net4Sage.Controls.Lookup.LookupShowColumn]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"ID")]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"ID")]
    ...
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Unidades Organizativas")]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    public partial class ThrOrganizativeUnit : EntityObject    {
        ...
        public static ThrOrganizativeUnit CreateThrOrganizativeUnit(int orgUnitKey, string orgUnitID, string companyID, string name, string costCenter, int valorSegmento, int horariokey)
        {
            ...
            thrOrganizativeUnit.Horariokey = horariokey;
    ...
    public partial class ThrPosition : EntityObject    {
        ...
        public static ThrPosition CreateThrPosition(int positionKey, string codigo, string positionID, short escalaGroupkey, int clasificationWorker, short estado, int ocupationCategoryKey, decimal hoursExtrasPay, decimal pagoxCargo, global::System.DateTime registerDate)
        {
    ...
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Horarios")]
    public partial class ThrShedule : EntityObject    {
        ...
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"ID Horario")]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"ID Horario")]
        [Net4Sage.Controls.Lookup.LookupShowColumn]
        [Net4Sage.Controls.Lookup.LookupTextReturn]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Tipo de Trabajador")]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Personas")]
    public partial class ThrPeople : EntityObject    {
        ...
        /// <param name="employRecEmpleadora">Initial value of EmployRecEmpleadora.</param>
        ...
        /// <param name="codWorker">Initial value of CodWorker.</param>
        /// <param name="codWorkerTecnosime">Initial value of CodWorkerTecnosime.</param>
        /// <param name="orgUnitKey">Initial value of OrgUnitKey.</param>
        public static ThrPeople CreateThrPeople(int personKey, string cI, string primerNombre, string primerApellido, string segundoApellido, short estato, short sex, global::System.DateTime birthDate, short skinColor, short eyesColor, short nacionalitykey, string addressAve, short addressStateKey, int positionKey, string employmentRecord, string employRecEmpleadora, global::System.DateTime registrerDate, int acumuladoVacations, string codWorker, string codWorkerTecnosime, int orgUnitKey)
        {
            ...
            thrPeople.EmployRecEmpleadora = employRecEmpleadora;
            thrPeople.RegistrerDate = registrerDate;
            thrPeople.AcumuladoVacations = acumuladoVacations;
            thrPeople.CodWorker = codWorker;
            thrPeople.CodWorkerTecnosime = codWorkerTecnosime;
        ...
        /// <summary>
        /// There are no comments for EmployRecEmpleadora in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual string EmployRecEmpleadora
        {
            get
            {
                string value = _EmployRecEmpleadora;
                OnGetEmployRecEmpleadora(ref value);
                return value;
            }
            set
            {
                if (_EmployRecEmpleadora != value)
                {
                  OnEmployRecEmpleadoraChanging(ref value);
                  ReportPropertyChanging("EmployRecEmpleadora");
                  _EmployRecEmpleadora = StructuralObject.SetValidValue(value, false);
                  ReportPropertyChanged("EmployRecEmpleadora");
                  OnEmployRecEmpleadoraChanged();
              }
            }
        }
        private string _EmployRecEmpleadora;
        partial void OnGetEmployRecEmpleadora(ref string value);
        partial void OnEmployRecEmpleadoraChanging(ref string value);
        partial void OnEmployRecEmpleadoraChanged();
        ...
        /// <summary>
        /// There are no comments for CodWorker in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual string CodWorker
        {
            get
            {
                string value = _CodWorker;
                OnGetCodWorker(ref value);
                return value;
            }
            set
            {
                if (_CodWorker != value)
                {
                  OnCodWorkerChanging(ref value);
                  ReportPropertyChanging("CodWorker");
                  _CodWorker = StructuralObject.SetValidValue(value, false);
                  ReportPropertyChanged("CodWorker");
                  OnCodWorkerChanged();
              }
            }
        }
        private string _CodWorker;
        partial void OnGetCodWorker(ref string value);
        partial void OnCodWorkerChanging(ref string value);
        partial void OnCodWorkerChanged();
    
        /// <summary>
        /// There are no comments for CodWorkerTecnosime in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual string CodWorkerTecnosime
        {
            get
            {
                string value = _CodWorkerTecnosime;
                OnGetCodWorkerTecnosime(ref value);
                return value;
            }
            set
            {
                if (_CodWorkerTecnosime != value)
                {
                  OnCodWorkerTecnosimeChanging(ref value);
                  ReportPropertyChanging("CodWorkerTecnosime");
                  _CodWorkerTecnosime = StructuralObject.SetValidValue(value, false);
                  ReportPropertyChanged("CodWorkerTecnosime");
                  OnCodWorkerTecnosimeChanged();
              }
            }
        }
        private string _CodWorkerTecnosime;
        partial void OnGetCodWorkerTecnosime(ref string value);
        partial void OnCodWorkerTecnosimeChanging(ref string value);
        partial void OnCodWorkerTecnosimeChanged();
        ...
        /// <summary>
        /// There are no comments for TurnoKey in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute()]
        [DataMemberAttribute()]
        public virtual int? TurnoKey
        {
            get
            {
                int? value = _TurnoKey;
                OnGetTurnoKey(ref value);
                return value;
            }
            set
            {
                if (_TurnoKey != value)
                {
                  OnTurnoKeyChanging(ref value);
                  ReportPropertyChanging("TurnoKey");
                  _TurnoKey = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("TurnoKey");
                  OnTurnoKeyChanged();
              }
            }
        }
        private int? _TurnoKey;
        partial void OnGetTurnoKey(ref int? value);
        partial void OnTurnoKeyChanging(ref int? value);
        partial void OnTurnoKeyChanged();
    ...
    [Net4Sage.Controls.Lookup.LookupTextReturn]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Condiciones Laborales")]
    ...
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Tipos de Subsidios")]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de tipos de Ausencia ")]
    public partial class ThrAbsence : EntityObject    {
        ...
        [DataMemberAttribute()]
        [Net4Sage.Controls.Lookup.LookupShowColumn]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"ID Ausencia")]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"ID Ausencia")]
        [Net4Sage.Controls.Lookup.LookupTextReturn]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Tipo de Licencia")]
    ...
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Deducciones")]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    ...
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Tipo de Movimiento")]
    public partial class ThrMovement : EntityObject    {
        ...
        [DataMemberAttribute()]
        [Net4Sage.Controls.Lookup.LookupShowColumn]
        [Net4Sage.Controls.Lookup.LookupColumnHeader(@"ID Movimiento")]
        [Net4Sage.Controls.Lookup.LookupColumnFilter(@"ID Movimiento")]
        [Net4Sage.Controls.Lookup.LookupTextReturn]
    ...
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    [Net4Sage.Controls.Lookup.LookupFormTitle(@"Búsqueda de Tipo de Retenciones")]
    [Net4Sage.Controls.Lookup.LookupAutoShowColumns(false)]
    ...
    public partial class ThrPeopleAbsence : EntityObject    {
        ...
        public static ThrPeopleAbsence CreateThrPeopleAbsence(int peopleAbsencekey, int absenceKey, int personKey, global::System.DateTime absenceFechaInicio, global::System.DateTime absenceFechaFin, decimal hoursDifrutadas, int periodkey)
        {
            ...
            thrPeopleAbsence.HoursDifrutadas = hoursDifrutadas;
        ...
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual decimal HoursDifrutadas
        {
            get
            {
                decimal value = _HoursDifrutadas;
        ...
        private decimal _HoursDifrutadas;
        partial void OnGetHoursDifrutadas(ref decimal value);
        partial void OnHoursDifrutadasChanging(ref decimal value);
    ...
    public partial class ThrPeopleIncidence : EntityObject    {
        ...
        /// <param name="hoursDifrutadas">Initial value of HoursDifrutadas.</param>
        /// <param name="periodkey">Initial value of Periodkey.</param>
        public static ThrPeopleIncidence CreateThrPeopleIncidence(int peopleIncidenceKey, int incidenceKey, int personKey, global::System.DateTime incidenceFechaInicio, global::System.DateTime incidenceFechaFin, int hoursDifrutadas, int periodkey)
        {
            ...
            thrPeopleIncidence.HoursDifrutadas = hoursDifrutadas;
    ...
    public partial class ThrPeopleLicence : EntityObject    {
        ...
        /// <param name="hoursDifrutadas">Initial value of HoursDifrutadas.</param>
        /// <param name="periodkey">Initial value of Periodkey.</param>
        public static ThrPeopleLicence CreateThrPeopleLicence(int peopleLicenceKey, int licenceKey, int personKey, global::System.DateTime licenceFechaInicio, global::System.DateTime licenceFechaFin, int hoursDifrutadas, int periodkey)
        {
            ...
            thrPeopleLicence.HoursDifrutadas = hoursDifrutadas;
    ...
    public partial class ThrPeopleSubsidy : EntityObject    {
        ...
        /// <param name="periodkey">Initial value of Periodkey.</param>
        public static ThrPeopleSubsidy CreateThrPeopleSubsidy(int peopleSubsidyKey, int subsidyKey, int personKey, global::System.DateTime subsidyFechaInicio, global::System.DateTime subsidyFechaFin, int hoursDifrutadas, int subsidyInicio, int subsidyHospitalizado, int periodkey)
        {
            ...
            thrPeopleSubsidy.HoursDifrutadas = hoursDifrutadas;
    ...
    /// <summary>
    /// There are no comments for Sage500AppModel.ThrDatosRptsTemporal in the schema.
    /// </summary>
    /// <KeyProperties>
    /// DatosRptsTemporalKey
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="Sage500AppModel", Name="ThrDatosRptsTemporal")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class ThrDatosRptsTemporal : EntityObject    {
        #region Factory Method

        /// <summary>
        /// Create a new ThrDatosRptsTemporal object.
        /// </summary>
        /// <param name="datosRptsTemporalKey">Initial value of DatosRptsTemporalKey.</param>
        /// <param name="expediente">Initial value of Expediente.</param>
        /// <param name="cI">Initial value of CI.</param>
        /// <param name="unidadOrg">Initial value of UnidadOrg.</param>
        /// <param name="primerNomnbre">Initial value of PrimerNomnbre.</param>
        /// <param name="primerApellido">Initial value of PrimerApellido.</param>
        /// <param name="estato">Initial value of Estato.</param>
        /// <param name="segundoNombre">Initial value of SegundoNombre.</param>
        /// <param name="segundoApellido">Initial value of SegundoApellido.</param>
        public static ThrDatosRptsTemporal CreateThrDatosRptsTemporal(int datosRptsTemporalKey, string expediente, string cI, int unidadOrg, string primerNomnbre, string primerApellido, short estato, string segundoNombre, string segundoApellido)
        {
            ThrDatosRptsTemporal thrDatosRptsTemporal = new ThrDatosRptsTemporal();
            thrDatosRptsTemporal.DatosRptsTemporalKey = datosRptsTemporalKey;
            thrDatosRptsTemporal.Expediente = expediente;
            thrDatosRptsTemporal.CI = cI;
            thrDatosRptsTemporal.UnidadOrg = unidadOrg;
            thrDatosRptsTemporal.PrimerNomnbre = primerNomnbre;
            thrDatosRptsTemporal.PrimerApellido = primerApellido;
            thrDatosRptsTemporal.Estato = estato;
            thrDatosRptsTemporal.SegundoNombre = segundoNombre;
            thrDatosRptsTemporal.SegundoApellido = segundoApellido;
            return thrDatosRptsTemporal;
        }
        ...
        /// <summary>
        /// There are no comments for DatosRptsTemporalKey in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(EntityKeyProperty=true, IsNullable=false)]
        [DataMemberAttribute()]
        public virtual int DatosRptsTemporalKey
        {
            get
            {
                int value = _DatosRptsTemporalKey;
                OnGetDatosRptsTemporalKey(ref value);
                return value;
            }
            set
            {
                if (_DatosRptsTemporalKey != value)
                {
                  OnDatosRptsTemporalKeyChanging(ref value);
                  ReportPropertyChanging("DatosRptsTemporalKey");
                  _DatosRptsTemporalKey = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("DatosRptsTemporalKey");
                  OnDatosRptsTemporalKeyChanged();
              }
            }
        }
        private int _DatosRptsTemporalKey;
        partial void OnGetDatosRptsTemporalKey(ref int value);
        partial void OnDatosRptsTemporalKeyChanging(ref int value);
        partial void OnDatosRptsTemporalKeyChanged();
        ...
        public virtual string Expediente
        {
            get
            {
                string value = _Expediente;
                OnGetExpediente(ref value);
                return value;
            }
            set
            {
                ...
                {
                  OnExpedienteChanging(ref value);
                  ReportPropertyChanging("Expediente");
                  _Expediente = StructuralObject.SetValidValue(value, false);
        ...
        partial void OnGetExpediente(ref string value);
        partial void OnExpedienteChanging(ref string value);
        ...
        /// <summary>
        /// There are no comments for UnidadOrg in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual int UnidadOrg
        {
            get
            {
                int value = _UnidadOrg;
                OnGetUnidadOrg(ref value);
                return value;
            }
            set
            {
                if (_UnidadOrg != value)
                {
                  OnUnidadOrgChanging(ref value);
                  ReportPropertyChanging("UnidadOrg");
                  _UnidadOrg = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("UnidadOrg");
                  OnUnidadOrgChanged();
              }
            }
        }
        private int _UnidadOrg;
        partial void OnGetUnidadOrg(ref int value);
        partial void OnUnidadOrgChanging(ref int value);
        partial void OnUnidadOrgChanged();
    
        /// <summary>
        /// There are no comments for PrimerNomnbre in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual string PrimerNomnbre
        {
            get
            {
                string value = _PrimerNomnbre;
                OnGetPrimerNomnbre(ref value);
                return value;
            }
            set
            {
                if (_PrimerNomnbre != value)
                {
                  OnPrimerNomnbreChanging(ref value);
                  ReportPropertyChanging("PrimerNomnbre");
                  _PrimerNomnbre = StructuralObject.SetValidValue(value, false);
                  ReportPropertyChanged("PrimerNomnbre");
                  OnPrimerNomnbreChanged();
              }
            }
        }
        private string _PrimerNomnbre;
        partial void OnGetPrimerNomnbre(ref string value);
        partial void OnPrimerNomnbreChanging(ref string value);
        partial void OnPrimerNomnbreChanged();
        ...
        public virtual string SegundoNombre
        {
            ...
            set
            {
                if (_SegundoNombre != value)
                {
                  OnSegundoNombreChanging(ref value);
                  ReportPropertyChanging("SegundoNombre");
                  _SegundoNombre = StructuralObject.SetValidValue(value, false);
                  ReportPropertyChanged("SegundoNombre");
                  OnSegundoNombreChanged();
              }
            }
        ...
        /// <summary>
        /// There are no comments for HorasVacaciones in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute()]
        [DataMemberAttribute()]
        public virtual int? HorasVacaciones
        {
            get
            {
                int? value = _HorasVacaciones;
                OnGetHorasVacaciones(ref value);
                return value;
            }
            set
            {
                if (_HorasVacaciones != value)
                {
                  OnHorasVacacionesChanging(ref value);
                  ReportPropertyChanging("HorasVacaciones");
                  _HorasVacaciones = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("HorasVacaciones");
                  OnHorasVacacionesChanged();
              }
            }
        }
        private int? _HorasVacaciones;
        partial void OnGetHorasVacaciones(ref int? value);
        partial void OnHorasVacacionesChanging(ref int? value);
        partial void OnHorasVacacionesChanged();
    
        /// <summary>
        /// There are no comments for HorasAusencias in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute()]
        [DataMemberAttribute()]
        public virtual decimal? HorasAusencias
        {
            get
            {
                decimal? value = _HorasAusencias;
                OnGetHorasAusencias(ref value);
                return value;
            }
            set
            {
                if (_HorasAusencias != value)
                {
                  OnHorasAusenciasChanging(ref value);
                  ReportPropertyChanging("HorasAusencias");
                  _HorasAusencias = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("HorasAusencias");
                  OnHorasAusenciasChanged();
              }
            }
        }
        private decimal? _HorasAusencias;
        partial void OnGetHorasAusencias(ref decimal? value);
        partial void OnHorasAusenciasChanging(ref decimal? value);
        partial void OnHorasAusenciasChanged();
    
        /// <summary>
        /// There are no comments for HorasSubsidios in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute()]
        [DataMemberAttribute()]
        public virtual int? HorasSubsidios
        {
            get
            {
                int? value = _HorasSubsidios;
                OnGetHorasSubsidios(ref value);
                return value;
            }
            set
            {
                if (_HorasSubsidios != value)
                {
                  OnHorasSubsidiosChanging(ref value);
                  ReportPropertyChanging("HorasSubsidios");
                  _HorasSubsidios = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("HorasSubsidios");
                  OnHorasSubsidiosChanged();
              }
            }
        }
        private int? _HorasSubsidios;
        partial void OnGetHorasSubsidios(ref int? value);
        partial void OnHorasSubsidiosChanging(ref int? value);
        partial void OnHorasSubsidiosChanged();
    
        /// <summary>
        /// There are no comments for HorasLicencias in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute()]
        [DataMemberAttribute()]
        public virtual int? HorasLicencias
        {
            get
            {
                int? value = _HorasLicencias;
                OnGetHorasLicencias(ref value);
                return value;
            }
            set
            {
                if (_HorasLicencias != value)
                {
                  OnHorasLicenciasChanging(ref value);
                  ReportPropertyChanging("HorasLicencias");
                  _HorasLicencias = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("HorasLicencias");
                  OnHorasLicenciasChanged();
              }
            }
        }
        private int? _HorasLicencias;
        partial void OnGetHorasLicencias(ref int? value);
        partial void OnHorasLicenciasChanging(ref int? value);
        partial void OnHorasLicenciasChanged();
    
        /// <summary>
        /// There are no comments for HorasOtrasIncidencias in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute()]
        [DataMemberAttribute()]
        public virtual int? HorasOtrasIncidencias
        {
            get
            {
                int? value = _HorasOtrasIncidencias;
                OnGetHorasOtrasIncidencias(ref value);
                return value;
            }
            set
            {
                if (_HorasOtrasIncidencias != value)
                {
                  OnHorasOtrasIncidenciasChanging(ref value);
                  ReportPropertyChanging("HorasOtrasIncidencias");
                  _HorasOtrasIncidencias = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("HorasOtrasIncidencias");
                  OnHorasOtrasIncidenciasChanged();
              }
            }
        }
        private int? _HorasOtrasIncidencias;
        partial void OnGetHorasOtrasIncidencias(ref int? value);
        partial void OnHorasOtrasIncidenciasChanging(ref int? value);
        partial void OnHorasOtrasIncidenciasChanged();

        #endregion
    }

    /// <summary>
    /// There are no comments for Sage500AppModel.ThrUnitTurno in the schema.
    /// </summary>
    /// <KeyProperties>
    /// TurnoKey
    /// </KeyProperties>
    [EdmEntityTypeAttribute(NamespaceName="Sage500AppModel", Name="ThrUnitTurno")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class ThrUnitTurno : EntityObject    {
        #region Factory Method

        /// <summary>
        /// Create a new ThrUnitTurno object.
        /// </summary>
        /// <param name="turnoKey">Initial value of TurnoKey.</param>
        /// <param name="orgUnitKey">Initial value of OrgUnitKey.</param>
        /// <param name="turnoName">Initial value of TurnoName.</param>
        /// <param name="turnoHorarioKey">Initial value of TurnoHorarioKey.</param>
        public static ThrUnitTurno CreateThrUnitTurno(int turnoKey, int orgUnitKey, string turnoName, int turnoHorarioKey)
        {
            ThrUnitTurno thrUnitTurno = new ThrUnitTurno();
            thrUnitTurno.TurnoKey = turnoKey;
            thrUnitTurno.OrgUnitKey = orgUnitKey;
            thrUnitTurno.TurnoName = turnoName;
            thrUnitTurno.TurnoHorarioKey = turnoHorarioKey;
            return thrUnitTurno;
        }
        ...
        /// <summary>
        /// There are no comments for TurnoName in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual string TurnoName
        {
            get
            {
                string value = _TurnoName;
                OnGetTurnoName(ref value);
                return value;
            }
            set
            {
                if (_TurnoName != value)
                {
                  OnTurnoNameChanging(ref value);
                  ReportPropertyChanging("TurnoName");
                  _TurnoName = StructuralObject.SetValidValue(value, false);
                  ReportPropertyChanged("TurnoName");
                  OnTurnoNameChanged();
              }
            }
        }
        private string _TurnoName;
        partial void OnGetTurnoName(ref string value);
        partial void OnTurnoNameChanging(ref string value);
        partial void OnTurnoNameChanged();
    
        /// <summary>
        /// There are no comments for TurnoHorarioKey in the schema.
        /// </summary>
        [EdmScalarPropertyAttribute(IsNullable=false)]
        [DataMemberAttribute()]
        public virtual int TurnoHorarioKey
        {
            get
            {
                int value = _TurnoHorarioKey;
                OnGetTurnoHorarioKey(ref value);
                return value;
            }
            set
            {
                if (_TurnoHorarioKey != value)
                {
                  OnTurnoHorarioKeyChanging(ref value);
                  ReportPropertyChanging("TurnoHorarioKey");
                  _TurnoHorarioKey = StructuralObject.SetValidValue(value);
                  ReportPropertyChanged("TurnoHorarioKey");
                  OnTurnoHorarioKeyChanged();
              }
            }
        }
        private int _TurnoHorarioKey;
        partial void OnGetTurnoHorarioKey(ref int value);
        partial void OnTurnoHorarioKeyChanging(ref int value);
        partial void OnTurnoHorarioKeyChanged();
