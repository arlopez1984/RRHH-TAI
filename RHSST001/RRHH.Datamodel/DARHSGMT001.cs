...
namespace RRHH.Datamodel
{
    ...
    {
        public List<ThrMovement> BuscarTiposMovimientos(string conexion)
        {
        ...
        public void RegistrarMovimientoTrasladoReubicacion(ThrPeopleMovement movement, string conex)
        {
        ...
        public void RegistrarMovimientoAltaBaja(ThrPeopleMovement movement, string conex)
        {
            using (var cont = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
            {
                using (var newcontexto = new Sage500AppEntities(conex.ToString()))
        ...
        public List<ThrPeopleMovement> BuscarMovimientosTrabajador(int personKey, int periodo, string conex)
        {
            using (var newcontexto = new Sage500AppEntities(conex.ToString()))
            {
        ...
        public ThrPeopleMovement BuscarMovimiento(int personKey, DateTime fecha, string conex)
        {
            using (var newcontexto = new Sage500AppEntities(conex.ToString()))
            {
        ...
        public bool EliminarMovimiento(ThrPeopleMovement movement, string conection)
        {
            bool dato = false;
