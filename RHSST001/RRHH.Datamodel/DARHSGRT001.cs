...
namespace RRHH.Datamodel
{
    ...
    {
        public void AdicionarRetencionesTrabajador(List<ThrPeopleRetention> listadoRetencionesXPersona, int periodo, string conex)
        {
            int deductionkey;
        ...
        public List<ThrPeopleRetention> RetencionesXPersona(int personkey, int periodo, string conection)
        {
        ...
        public bool EliminarRetencionesXPersonas(int personkey, int periodo, string conection)
        {
            using (var cont = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
            {
                bool dato = false;
