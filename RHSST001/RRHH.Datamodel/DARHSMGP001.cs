...
namespace RRHH.Datamodel
{
    ...
    {
        public ThrOperationsPeriod BuscarPeriodoActivo(string conex)
        {
        ...
        public bool AgregarOperacionPeriodo(ThrOperationsPeriod operac, string conex)
        {
            //bool insertar = false;
            using (var newcontexto = new Sage500AppEntities(conex.ToString()))
            {                
                ...
                //if (objPeriodo != null)
                //{
                //    objPeriodo.PeriodFechaInicio = operac.PeriodFechaInicio;
                //    objPeriodo.PeriodFechaFin = operac.PeriodFechaFin;
                //    objPeriodo.PeriodEstado = 1;
                //    newcontexto.SaveChanges();
                //    return true;                   
                //}
                //else
                //{
                    var operacionAbierta = newcontexto.ThrOperationsPeriods.Where(d => d.PeriodEstado == 1).FirstOrDefault();
        ...
        public bool CerrarOperacionPeriodo(string conex)
        {
        ...
        public List<ThrOperationsPeriod> BuscarPeriodos(string conex)
        {
            using (var newcontexto = new Sage500AppEntities(conex.ToString()))
            {
