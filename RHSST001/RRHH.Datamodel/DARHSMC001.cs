...
namespace RRHH.Datamodel
{
    ...
    {        
        ...
        public ThrPosition BuscarCargo(string cargo, string conex)
        {
        ...
        public ThrPosition BuscarCargoXkey(int cargoKey, string conex)
        {
            using (var newcontexto = new Sage500AppEntities(conex.ToString()))
            {
                ThrPosition position = new ThrPosition();
        ...
        public List<ThrPosition> BuscarCargosXUnidad(int unidadOrgKey, string conex)
        {
            using (var newcontexto = new Sage500AppEntities(conex.ToString()))
            {
                ThrPosition nuevo;
        ...
        public void EliminarCargo(ThrPosition cargo, string conex)
        {
        ...
        public void AdicionarCargo(ThrPosition cargo, List<clsUnidadesOrganizativas> listadoUnidadesOrg, List<clsCondicionesAnormales> listadoCondiciones, List<clsCompetencias> listadoCompetencias, List<clsCondicionLaboral> listadoCondicionesLab, List<clsRiesgo> listadoRiegosLab, string conex)
        {
            int positionkey;
            using (var cont = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions { IsolationLevel = System.Transactions.IsolationLevel.ReadUncommitted }))
            {
                ...
                using (var newcontexto = new Sage500AppEntities(conex.ToString()))
                {
                    ...
                    if (objPosition != null)
                    {
                        ...
                        objPosition.EstimulacionCuc = cargo.EstimulacionCuc;
        ...
        public int BuscarDependenciasConCargo(int cargokey, string conexion)
        {
        ...
        public List<ThrPosition> Actualizar(string conexion)
        {
            using (var newcontexto = new Sage500AppEntities(conexion.ToString()))
            {
        ...
        public List<ThrOrgUnitPosition> BuscarOrgUnidadesPosition(int positionKey, string conexion)
        {
            using (var newcontexto = new Sage500AppEntities(conexion.ToString()))
            {
        ...
        public ThrEscalaGroup BuscarGroupEscala(string conexion, int groupescalagKey)
        {
            using (var newcontexto = new Sage500AppEntities(conexion.ToString()))
            {
